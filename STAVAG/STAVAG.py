...
def DVG_detection(
    ...
    Args:
        ...
        sps : bool, optional
            Whether to compute STAVAG priority scores (sps) by comparing with random feature importances (default: False).
        threshold : (float, optional)
        threshold for selecting DVGs, set higher to get more DVGs.
...
def TVG_detection(
    ...
    Args:
        ...
        sps : bool, optional
            Whether to compute STAVAG priority scores (sps) by comparing with random feature importances (default: False).
        threshold : (float, optional)
        threshold for selecting TVGs, set higher to get more TVGs.
...
def gene_modules(adata, gene_list):
    ...
    Args:
        adata: AnnData object that contains the expression matrix.
        gene_list: List of genes to consider when building modules.

    Returns:
        A tuple of three objects
        1 Z  The linkage matrix from hierarchical clustering
        2 corr  The gene to gene correlation DataFrame
        3 df  The expression DataFrame of the selected genes
