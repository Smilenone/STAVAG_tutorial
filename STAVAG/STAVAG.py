...
def gene_modules(adata, gene_list):
    ...
    Returns:
        Tuple[np.ndarray, pd.DataFrame, pd.DataFrame]:
            ...
            corr: Gene-to-gene correlation matrix as a DataFrame. Index and
                columns are gene names in ``gene_list``.
            df: Expression matrix of the selected genes as a DataFrame. Rows are
